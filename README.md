As part of my final year project, my team and I developed an "Automatic Routine Generator using Genetic Algorithm". The aim of the project was to tackle the complex problem of creating timetables for institutes that deal with theory classes, laboratory classes, tutorials, and breaks.
